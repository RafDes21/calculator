package com.rafdev.calculadora.screens.calculator
...
import com.rafdev.calculadora.util.CalculatorErrors
import dagger.hilt.android.lifecycle.HiltViewModel
import javax.inject.Inject


@HiltViewModel
class CalculatorViewModel @Inject constructor(private val getDataButtonUseCase: GetDataButtonUseCase) :
    ViewModel() {
...
//                throw RuntimeException("Test Crash")
                try {
                    ...
                    _result.value = CalculatorErrors.SYNTAX_ERROR
                } catch (e: ArithmeticException) {
                    _result.value = CalculatorErrors.ARITHMETIC_ERROR
                } catch (e: Exception) {
                    _result.value = CalculatorErrors.UNKNOWN_ERROR
                }
            }
